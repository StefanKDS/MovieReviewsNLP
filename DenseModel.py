...
# Fit the model
history_Dense = model_1.fit(train_sentences,
                              train_labels,
                              epochs=5,
                              callbacks=callbacks,
                              validation_data=(val_sentences, val_labels))

np.save('Auswertung/history_dense.npy', history_Dense.history)
...
model_1.save('Auswertung/model_dense')

from helper_functions import plot_saved_loss_curves
plot_saved_loss_curves('Auswertung/history_dense.npy')